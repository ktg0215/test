    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_at', models.CharField(choices=[('1', '14'), ('2', '16'), ('3', '17'), ('4', '17.5'), ('5', '18'), ('6', '18.5'), ('7', '19'), ('8', '19.5'), ('9', '20'), ('10', '〇')], max_length=50, verbose_name='入')),
                ('end_at', models.CharField(choices=[('1', '22'), ('2', '23'), ('3', '〇')], max_length=50, verbose_name='出')),
                ('date', models.DateField(verbose_name='日付')),
                ('shops', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='register.Shops', verbose_name='店舗')),
